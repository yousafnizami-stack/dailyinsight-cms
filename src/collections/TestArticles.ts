...
export const TestArticles: CollectionConfig = {
  slug: 'test-articles',
  labels: { singular: 'Test Article', plural: 'Test Articles' },
  access: {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'select',
      options: [
        { label: 'Royal Correspondent', value: 'Royal Correspondent' },
        { label: 'Entertainment Desk', value: 'Entertainment Desk' },
        { label: 'Music Desk', value: 'Music Desk' },
        { label: 'Film Desk', value: 'Film Desk' },
