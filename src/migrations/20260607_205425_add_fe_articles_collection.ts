...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "fe_articles_source_urls" CASCADE;
  DROP TABLE "fe_articles_embeds" CASCADE;
  DROP TABLE "fe_articles_tags" CASCADE;
  DROP TABLE "fe_articles_headline_variants" CASCADE;
  DROP TABLE "fe_articles" CASCADE;
  ALTER TABLE "payload_locked_documents_rels" DROP CONSTRAINT "payload_locked_documents_rels_fe_articles_fk";
  
  DROP INDEX "payload_locked_documents_rels_fe_articles_id_idx";
  ALTER TABLE "payload_locked_documents_rels" DROP COLUMN "fe_articles_id";
  DROP TYPE "public"."enum_fe_articles_status";
  DROP TYPE "public"."enum_fe_articles_author";
  DROP TYPE "public"."enum_fe_articles_article_type";`)
}
