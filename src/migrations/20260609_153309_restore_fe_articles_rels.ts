...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ...
   EXCEPTION WHEN duplicate_object THEN null; END $$;
   CREATE TABLE IF NOT EXISTS "fe_articles_source_urls" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"url" varchar
  );
  CREATE TABLE IF NOT EXISTS "fe_articles_embeds" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"platform" varchar,
  ...
  CREATE TABLE IF NOT EXISTS "fe_articles_tags" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"tag" varchar
  );
  CREATE TABLE IF NOT EXISTS "fe_articles_headline_variants" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"variant" varchar
  );
  CREATE TABLE IF NOT EXISTS "fe_articles" (
  ...
  ALTER TABLE "payload_locked_documents_rels" ADD COLUMN IF NOT EXISTS "fe_articles_id" integer;
  DO $$ BEGIN
  ...
  EXCEPTION WHEN duplicate_object THEN null; END $$;
  CREATE INDEX IF NOT EXISTS "fe_articles_source_urls_order_idx" ON "fe_articles_source_urls" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "fe_articles_source_urls_parent_id_idx" ON "fe_articles_source_urls" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "fe_articles_embeds_order_idx" ON "fe_articles_embeds" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "fe_articles_embeds_parent_id_idx" ON "fe_articles_embeds" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "fe_articles_tags_order_idx" ON "fe_articles_tags" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "fe_articles_tags_parent_id_idx" ON "fe_articles_tags" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "fe_articles_headline_variants_order_idx" ON "fe_articles_headline_variants" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "fe_articles_headline_variants_parent_id_idx" ON "fe_articles_headline_variants" USING btree ("_parent_id");
  CREATE INDEX IF NOT EXISTS "fe_articles_category_idx" ON "fe_articles" USING btree ("category_id");
  CREATE INDEX IF NOT EXISTS "fe_articles_featured_image_idx" ON "fe_articles" USING btree ("featured_image_id");
  CREATE UNIQUE INDEX IF NOT EXISTS "fe_articles_slug_idx" ON "fe_articles" USING btree ("slug");
  CREATE INDEX IF NOT EXISTS "fe_articles_updated_at_idx" ON "fe_articles" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "fe_articles_created_at_idx" ON "fe_articles" USING btree ("created_at");
  DO $$ BEGIN
  ...
  EXCEPTION WHEN duplicate_object THEN null; END $$;
  CREATE INDEX IF NOT EXISTS "payload_locked_documents_rels_fe_articles_id_idx" ON "payload_locked_documents_rels" USING btree ("fe_articles_id");`)
}

export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  await db.execute(sql`
   ALTER TABLE "fe_articles_source_urls" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "fe_articles_embeds" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "fe_articles_tags" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "fe_articles_headline_variants" DISABLE ROW LEVEL SECURITY;
  ALTER TABLE "fe_articles" DISABLE ROW LEVEL SECURITY;
